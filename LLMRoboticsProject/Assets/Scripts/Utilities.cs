public class Utilities
{
    ...
    public static readonly string LRDDAsk = @"Given the image with a black disk and a red disk, is the black disk on the left or right of the red disk? Please respond with only one word: 'left', or 'right'";
